import {View, Text,FlatList,TouchableOpacity,Platform,PermissionsAndroid,Linking,Image} from 'react-native';
  ...
  return (
    <View style={{flex:1}}>
        ...
        <View style={{backgroundColor:COLORS.white,padding:10,flexDirection:'row',justifyContent:'flex-end'}}>
            <Text style={{alignSelf:'center',fontWeight:'bold',fontSize:20,color:COLORS.black,marginRight:100}}>Shifts</Text>
      ...
      <Text style={{padding:5,marginTop:5}}>223 sgifts found for your location within 23 miles</Text>
      <View style={{flex:1}}>
        <FlatList
        data={data || []}
        renderItem={Item}
